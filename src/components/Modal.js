  ...
  function connexion(data){
    fetch('http://edu.project.etherial.fr/auth', {
      ...
      res.json().then((json) =>{
        ...
        setTokenStore(json.data.token)
        setShowModal(false)
      })
     })
  }
  const onSubmit = data => connexion(data);
          ...
          >
            ...
            {/* <div class="py-6 px-6 lg:px-8">
                <div class="space-y-6" action="#">
                    ...
                    <button type="submit" onClick={() => connexion()}  class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login to your account</button>
